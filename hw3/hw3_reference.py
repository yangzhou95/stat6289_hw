...
import os
print("current wk dir: %s" %(os.getcwd()))

for dirname, _, filenames in os.walk('/Users/zhou/Documents/github/stat6289_hw/hw3/input'):
    for i, filename in enumerate(filenames):
        if i<2: #print the full path of the first two files.
...
def stocks_data(symbols, dates):
    ...
    for symbol in symbols:
        df_temp = pd.read_csv("./hw3/input/Data/Stocks/{}.us.txt".format(symbol),
                              index_col='Date',
                              parse_dates=True,
                              usecols=['Date', 'Close'],
                              na_values=['nan'])
...
df_ibm=pd.read_csv("./hw3/input/Data/Stocks/ibm.us.txt", parse_dates=True, index_col=0)
